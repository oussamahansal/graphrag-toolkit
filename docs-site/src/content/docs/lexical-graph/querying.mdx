...
The lexical-graph uses a [traversal-based search](https://github.com/awslabs/graphrag-toolkit/blob/main/docs/lexical-graph/traversal-based-search.md) strategy that combines similarity search with graph traversal. A [semantic-guided search](https://github.com/awslabs/graphrag-toolkit/blob/main/docs/lexical-graph/semantic-guided-search.md) approach also exists but is likely to be retired in a future release.

Querying supports [metadata filtering](https://github.com/awslabs/graphrag-toolkit/blob/main/docs/lexical-graph/metadata-filtering.md) and [multi-tenancy](https://github.com/awslabs/graphrag-toolkit/blob/main/docs/lexical-graph/multi-tenancy.md).
...
You can also construct `LexicalGraphQueryEngine` directly, passing `system_prompt`, `user_prompt`, or a `prompt_provider` kwarg. See [Using Custom Prompt Providers](https://github.com/awslabs/graphrag-toolkit/blob/main/docs/lexical-graph/prompts.md).
...
- [Traversal-Based Search](https://github.com/awslabs/graphrag-toolkit/blob/main/docs/lexical-graph/traversal-based-search.md)
- [Configuring and Tuning Traversal-Based Search](https://github.com/awslabs/graphrag-toolkit/blob/main/docs/lexical-graph/traversal-based-search-configuration.md)
- [Metadata Filtering](https://github.com/awslabs/graphrag-toolkit/blob/main/docs/lexical-graph/metadata-filtering.md)
- [Multi-Tenancy](https://github.com/awslabs/graphrag-toolkit/blob/main/docs/lexical-graph/multi-tenancy.md)
